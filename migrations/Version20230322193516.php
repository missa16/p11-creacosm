 ...
 */
final class Version20230322193516 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE sondage (id INT NOT NULL, categorie_sondage_id INT DEFAULT NULL, sondeur_id INT NOT NULL, intitule VARCHAR(255) NOT NULL, etat_sondage VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, image_couverture VARCHAR(255) DEFAULT NULL, date_creation TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, date_lancement TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, date_fin TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, date_update TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE user_sondage_result (id INT NOT NULL, sondage_id INT NOT NULL, date_reponse TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
