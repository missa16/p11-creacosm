 ...
 */
final class Version20230227144617 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE type_question (id INT NOT NULL, intitule_type VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
    }
