 ...
 */
final class Version20230328103621 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE categorie_sondage (id INT NOT NULL, nom_categorie VARCHAR(255) NOT NULL, emoji VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE formation (id INT NOT NULL, nom_formation VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE question (id INT NOT NULL, type_question_id INT NOT NULL, sondage_id INT NOT NULL, intitule VARCHAR(255) NOT NULL, image_question VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE sondage (id INT NOT NULL, categorie_sondage_id INT DEFAULT NULL, sondeur_id INT NOT NULL, intitule VARCHAR(255) NOT NULL, etat_sondage VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, image_couverture VARCHAR(255) DEFAULT NULL, date_creation TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, date_fin TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, date_update TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE stats_question (id INT NOT NULL, question_id INT DEFAULT NULL, nom_stat VARCHAR(255) NOT NULL, data_json VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_A3B4DE461E27F6BF ON stats_question (question_id)');
        $this->addSql('CREATE TABLE type_question (id INT NOT NULL, intitule_type VARCHAR(255) NOT NULL, is_multiple BOOLEAN NOT NULL, is_expanded BOOLEAN NOT NULL, label VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE "user" (id INT NOT NULL, formation_id INT DEFAULT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, date_naissance TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, ville VARCHAR(255) NOT NULL, genre VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE user_sondage_result (id INT NOT NULL, sondage_id INT NOT NULL, sonde_id INT NOT NULL, date_reponse TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE "user" ADD CONSTRAINT FK_8D93D6495200282E FOREIGN KEY (formation_id) REFERENCES formation (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE "user" DROP CONSTRAINT FK_8D93D6495200282E');
